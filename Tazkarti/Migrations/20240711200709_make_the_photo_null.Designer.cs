...
{
    [DbContext(typeof(TazkartiDB))]
    [Migration("20240711200709_make_the_photo_null")]
    partial class make_the_photo_null
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tazkarti.Models.AppUser.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Tazkarti.Models.Entertainment.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AllowedNumberOfPeople")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tazkarti.Models.Entertainment.EventTicket", b =>
                {
            ...
            modelBuilder.Entity("Tazkarti.Models.Sport.MatchTicket", b =>
                {
                    b.Property<int>("TicketId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Tazkarti.Models.AppUser.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tazkarti.Models.Entertainment.Event", b =>
                {
                    b.HasOne("Tazkarti.Models.Entertainment.Category", "Category")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Tazkarti.Models.Entertainment.EventTicket", b =>
                {
                    b.HasOne("Tazkarti.Models.Entertainment.Event", "Event")
                        .WithMany()
